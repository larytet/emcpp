...
template<typename ObjectType, typename Lock, std::size_t Size> class Stack: Container {
public:
...
int main() {
    ...
    {
        uint8_t val;
        myMemoryPool.push((uint8_t)&dummyDataBlock);
        myMemoryPool.pop(&dummyDataBlock);
        myMemoryPool.push((uint8_t)&dummyDataBlock);
        myMemoryPool.pop(&dummyDataBlock);
        myMemoryPool.push((uint8_t)&dummyDataBlock);
        myMemoryPool.pop(&dummyDataBlock);
